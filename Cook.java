...
public class Cook {
    ...
    Cook() { // cook and time till when the chef will be occupied
        cook.add(0);
        cook.add(0);
        cook.add(0);
        cook.add(0);
    ...
    // Cook(Bill bill) { // order number starts with 1
    // this.order_number = bill.order_number;
    // this.qty = bill.qty;
    // this.item = bill.item;
    // this.rate = bill.rate;
    // this.prep_time = bill.prep_time;
    // this.order_time = bill.order_time;
    // }
    Cook(Order O) {
        this.O = O;
